...
{
    public class LibroDeletePage
    {
        private readonly IWebDriver _driver;
        private readonly WebDriverWait _wait;

        public LibroDeletePage(IWebDriver driver)
        {
            _driver = driver;
        ...
        public bool IsOnDeletePage()
        {
            try
            {
                return PageTitle.Text.Contains("Eliminar") && _driver.Url.Contains("/Libro/Delete");
            }
            catch (Exception)
            {
                return false;
        ...
        public void ConfirmDelete()
        {
            try
            {
                ...
                _wait.Until(driver => driver.Url.Contains("/Libro") && !driver.Url.Contains("/Delete"));
