...
{
    public class EjemplarDeletePage
    {
        private readonly IWebDriver _driver;
        private readonly WebDriverWait _wait;

        public EjemplarDeletePage(IWebDriver driver)
        {
            _driver = driver;
        ...
        public bool IsOnDeletePage()
        {
            try
            {
                return PageTitle.Text.Contains("Eliminar") && _driver.Url.Contains("/Ejemplar/Delete");
            }
            catch (Exception)
            {
                return false;
        ...
        public void ConfirmDelete()
        {
            try
            {
                ...
                _wait.Until(driver => driver.Url.Contains("/Ejemplar") && !driver.Url.Contains("/Delete"));
